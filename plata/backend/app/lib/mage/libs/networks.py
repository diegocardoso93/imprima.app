    ...
    def __init__(self, name="u2net"):
        ...
        try:
            if self.torch.cuda.is_available():
                net.load_state_dict(self.torch.load(os.path.join(os.path.dirname(__file__), "..", "models", name, name + '.pth')))
                net.cuda()
            else:
                net.load_state_dict(self.torch.load(os.path.join(os.path.dirname(__file__), "..", "models", name, name + '.pth'), map_location="cpu"))
